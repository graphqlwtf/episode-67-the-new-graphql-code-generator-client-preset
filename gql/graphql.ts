...
export type GetCartByIdQuery = { __typename?: 'Query', cart?: { __typename?: 'Cart', id: string, totalItems?: number | null, items: Array<{ __typename?: 'CartItem', id: string, name?: string | null, unitTotal: { __typename?: 'Money', formatted: string } }> } | null };
